...
export const styles = StyleSheet.create({
  ...
  userName: { fontSize: 19, fontWeight: "700", color: COLORS.textNormal },
  userPhone: { fontSize: 17, fontWeight: "500", color: COLORS.textLight },
  locationContainer: { flexDirection: "row", alignItems: "center", marginTop: 4 },
  locationText: { fontSize: 16, color: COLORS.textNormal, marginLeft: 4, fontWeight: "600" },
  ...
  instructionTitle: { fontSize: 22, fontWeight: "800", color: "#FF7A45", marginBottom: 12 },
  instructionItem: { fontSize: 17, color: "#454B5E", marginBottom: 6, fontWeight: "500" },
  ...
  statusText: { fontSize: 19, fontWeight: "500", color: "#555", textAlign: "center", marginTop: 30 },
  ...
  incidentTitle: { fontSize: 17, fontWeight: "800", color: "#2D3142", textAlign: "center", marginBottom: 20 },
  ...
  incidentText: { fontSize: 17, fontWeight: "600", color: "#333" },
  ...
  formTitleText: { fontSize: 24, fontWeight: '800', color: '#2D3142', marginLeft: 8 },
  ...
  infoName: { fontSize: 16, fontWeight: '700', color: '#2D3142' },
  infoPhone: { fontWeight: '400', color: '#777' },
  infoLocationRow: { flexDirection: 'row', alignItems: 'center', marginTop: 4 },
  infoAddress: { fontSize: 15, color: '#555', marginLeft: 4, flex: 1 },
  formInput: { backgroundColor: '#F9FAFB', borderWidth: 1, borderColor: '#E5E7EB', borderRadius: 15, padding: 15, height: 100, textAlignVertical: 'top', fontSize: 17, color: '#2D3142', marginBottom: 20 },
  ...
  mediaText: { fontSize: 15, color: '#555', marginTop: 8, fontWeight: '500' },

  // --- NÚT GỬI ---
  sendNowButtonText: { color: "#FFF", fontSize: 18, fontWeight: "bold", },

  // --- ĐẾM NGƯỢC ---
  modalTitle: { fontSize: 22, fontWeight: "900", color: "#FF8852", textAlign: 'center', marginTop: 10 },
  modalSubTitle: { fontSize: 18, color: "#666", textAlign: 'center', marginVertical: 8 },
